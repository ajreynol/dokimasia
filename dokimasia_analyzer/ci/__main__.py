"""Command line for the CI-integrity analysis.
    ...
    python3 -m dokimasia_analyzer.ci proofs   <cvc5>   # is proof testing still attached?
    python3 -m dokimasia_analyzer.ci matrix   <cvc5>   # job x tester
    python3 -m dokimasia_analyzer.ci testers  <cvc5>   # what each tester actually passes
    python3 -m dokimasia_analyzer.ci baseline <cvc5> --check
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.ci",
