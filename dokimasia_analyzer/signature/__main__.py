"""Command line for the signature cross-check.
    ...
    python3 -m dokimasia_analyzer.signature rules   <cvc5>   # printable rules vs the signature
    python3 -m dokimasia_analyzer.signature skolems <cvc5>   # SkolemIds: documented, built, printable
    python3 -m dokimasia_analyzer.signature arity   <cvc5>   # doc vs signature arity (noisy; read the caveat)
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.signature",
