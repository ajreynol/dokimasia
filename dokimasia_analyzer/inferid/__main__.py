"""Command line for the InferenceId subtool.
    ...
    python3 -m dokimasia_analyzer.inferid check    <cvc5>   # ids used in more than one place
    python3 -m dokimasia_analyzer.inferid show     <cvc5> STRINGS_F_UNIFY
    python3 -m dokimasia_analyzer.inferid dead     <cvc5>   # declared, never produced
    python3 -m dokimasia_analyzer.inferid stats    <cvc5>
    python3 -m dokimasia_analyzer.inferid baseline <cvc5> --check
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.inferid",
