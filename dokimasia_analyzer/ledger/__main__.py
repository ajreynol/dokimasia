"""Command line for the proof-rule ledger.
    ...
    python3 -m dokimasia_analyzer.ledger holes    <cvc5>   # rows with a hole
    python3 -m dokimasia_analyzer.ledger table    <cvc5>   # every rule, four columns
    python3 -m dokimasia_analyzer.ledger rule     <cvc5> TRUST
    python3 -m dokimasia_analyzer.ledger baseline <cvc5> --check
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.ledger",
    ...
    b.add_argument("cvc5")
    b.add_argument("--file", default=baseline("ledger"))
