"""Command line for the option-gate analysis.
    ...
    python3 -m dokimasia_analyzer.gates kinds    <cvc5>   # Kind -> option that legalises it
    python3 -m dokimasia_analyzer.gates rule     <cvc5> LAMBDA_ELIM
    python3 -m dokimasia_analyzer.gates verdicts <cvc5>   # every rewrite rule, in safe mode
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.gates",
