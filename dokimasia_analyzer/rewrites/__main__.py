"""Command line for rewrite-rule coverage.
    ...
    python3 -m dokimasia_analyzer.rewrites coverage <cvc5>   # the four-way split
    python3 -m dokimasia_analyzer.rewrites gaps     <cvc5>   # applied, and unprintable
    python3 -m dokimasia_analyzer.rewrites baseline <cvc5> --check
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.rewrites",
