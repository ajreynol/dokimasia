"""Command line for the TCB subtool.
    ...
    python3 -m dokimasia_analyzer.tcb measure  <cvc5>   # the headline numbers
    python3 -m dokimasia_analyzer.tcb cuts     <cvc5>   # which edges carry the weight
    python3 -m dokimasia_analyzer.tcb baseline <cvc5>   # write or check a ratchet
"""
...
EXEC_WARNING = (
    ...
    "         See dokimasia_analyzer/tcb/closure.py for the measurement.\n"
)
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.tcb",
