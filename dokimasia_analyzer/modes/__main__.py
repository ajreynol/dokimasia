"""Command line for the modes subtool.
    ...
    python3 -m dokimasia_analyzer.modes delta    <cvc5>   # what safe mode changes
    python3 -m dokimasia_analyzer.modes list     <cvc5>   # every guarded option change
    python3 -m dokimasia_analyzer.modes baseline <cvc5>   # track the list over time
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.modes",
