"""Command line for the trust census.
    ...
    python3 -m dokimasia_analyzer.trust census   <cvc5>   # every TrustId, by subsystem
    python3 -m dokimasia_analyzer.trust show     <cvc5> THEORY_LEMMA
    python3 -m dokimasia_analyzer.trust dead     <cvc5>   # declared, never constructed
    python3 -m dokimasia_analyzer.trust passes   <cvc5>   # preprocessing correspondence
    python3 -m dokimasia_analyzer.trust baseline <cvc5> --check
"""
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(
        prog="python3 -m dokimasia_analyzer.trust",
