...
def test_prompts():
    ...
    cases = [
        ...
        ("process_dokimasia, from a checkout",
         ["scripts/prompts/process_dokimasia", "--show-prompt", ROOT, "ID"],
