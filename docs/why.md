...
Everything below was measured against cvc5 `40a4bb7e4` and each row names the
...
Writing this page, we ran all eight against `40a4bb7e4` — **the commit they
...
are clean at `40a4bb7e4`; and the delta now separates *reconstructed* from *no
